...
**Kind**: instance method of [<code>Korra</code>](#Korra)
**Returns**: <code>Promise.&lt;any&gt;</code> - The image buffer
...
All errors rejected from a Taihou methods rejects an instance of the TaihouError class, as described below, additional properties may be added to the error 
